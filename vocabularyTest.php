...
if (cat1) { categories.push(cat1name); count=count-1; };            
if (cat2) { categories.push(cat2name); count=count-1; };            
if (cat3) { categories.push(cat3name); count=count-1;  };            
if (cat4) { categories.push(cat4name); count=count-1; };            
if (cat5) { categories.push(cat5name); count=count-1; };            
if (cat6) { categories.push(cat6name); count=count-1; };            
if (cat7) { categories.push(cat7name); count=count-1; };            
if (cat8) { categories.push(cat8name); count=count-1; };            
if (cat9) { categories.push(cat9name); count=count-1; };            
if (cat10) { categories.push(cat10name); count=count-1; };            
...
// send count variable to page quizResult.php
$.post('http://localhost/materialize2.0/quizResultToDatabase.php', { "count" : count});                     
